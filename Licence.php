...
<body>
  ...
  <li class="nav-item">
    <a class="nav-link bg-secondary" style="color:white" href="Licence.php">License</a>
  </li>
  <li class="nav-item">
 ...
 <div class="utilisateur mt-5">
       <hr>
        ...
        <form class="form-inline" method="post" action="Script/Licence.php">
            <div class="input-group mb-2">
              <div class="input-group-prepend">
                <div class="input-group-text"> <i class="bx bx-user"></i></div>
              </div>
              <input type="text" class="form-control" id="inlineFormInputGroup" name="rechercheLicence" placeholder="Inserer le Licence..." aria-label="Search">
...
<form class="form-inline">
    <div class="input-group mb-2">
      ...
      <input type="text" class="form-control" id="inlineFormInputGroup" name="rechercheArbitre" placeholder="rechercher le Arbitre...">          
    </div>
</form>
</div> 
