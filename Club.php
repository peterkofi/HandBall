...
<body>
  ...
  <li class="nav-item">
    <a class="nav-link " href="Athlete">Athlète</a>
  </li>
  <li class="nav-item">
    <a class="nav-link bg-secondary" style="color:white" href="Club.php">Club</a>
  </li>
  <li class="nav-item">
      ...
      <div class="d-flex justify-content-between">
        ...
        <form class="form-inline">
            <div class="input-group mb-2">
              ...
              <input type="text" class="form-control" id="inlineFormInputGroup" name="rechercheClub" placeholder="rechercher le club...">          
            </div>
        </form>
        </div>
