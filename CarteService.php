...
<body>
 ...
 <div class="CarteService mt-5">
      ...
      <div class="listeCarteService shadow-sm">

      <div class="d-flex justify-content-between">

        <div class="section-title" data-aos="fade">
          <h6>Liste Carte de service</h6>
        </div>
        ...
        <form class="form-inline">
            <div class="input-group mb-2">
              ...
              <input type="text" class="form-control" id="inlineFormInputGroup" name="rechercheCarteService" placeholder="rechercher la Carte de service...">          
            </div>
        </form>
        </div>
